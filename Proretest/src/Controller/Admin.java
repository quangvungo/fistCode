...
public class Admin {
    ...
    public Admin() {
        ...
        try {
            addReadObject("src\\RentCustomer.txt");
            addReadObject("src\\BuyCustomer.txt");
            addReadObject("src\\BuyBook.txt");
            addReadObject("C:src\\RentBook.txt");
    ...
    public void addReadObject(String fileName) throws NumberFormatException, ParseException {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(path))) {
            if (fileName.equals("src\\BuyBook.txt")) {
                addBbooklist(reader);
            } else if (fileName.equals("src\\BuyCustomer.txt")) {
                addBcuslist(reader);
            } else if (fileName.equals("src\\RentBook.txt")) {
                addRbooklist(reader);
            } else if (fileName.equals("src\\RentCustomer.txt")) {
                addRcuslist(reader);
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void writeBooksToFile() {
        String bookFilePath = System.getProperty("user.dir") + File.separator + "src\\Book.txt";
    ...
    public void writeCustomersToFile() {
        String customerFilePath = System.getProperty("user.dir") + File.separator + "src\\Customer.txt";
    ...
    public ArrayList<String> readBookReview() throws FileNotFoundException, IOException {
        try (BufferedReader reader = new BufferedReader(new FileReader("src\\Review.txt"))) {
            String line;
            try {
                while ((line = reader.readLine()) != null) {
                    String[] data = line.split(";");
    ...
    public void writeBookReview() throws IOException {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("src\\Review.txt"))) {
    ...
    public void writeRbooklist(ArrayList<RentBook> books) throws IOException, ParseException {
        String bookFilePath = System.getProperty("user.dir") + File.separator + "src\\RentedBook.txt";
